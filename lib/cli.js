...
const cli = cac('create-frourio-app')
...
const showEnvInfo = async () => {
  ...
  const result = await envinfo.run({
    ...
    npmGlobalPackages: ['frourio', 'create-frourio-app']
  })
  console.log(result)
  process.exit(1)
}
...
cli
  ...
  .action((outDir = '.', cliOptions) => {
    ...
    console.log()
    console.log(chalk`{cyan create-frourio-app v${version}}`)
    console.log(chalk`✨  Generating frourio project in {cyan ${outDir}}`)

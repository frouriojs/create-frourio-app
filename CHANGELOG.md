...
## [0.37.0](https://github.com/frouriojs/create-frourio-app/compare/v0.36.0...v0.37.0) (2023-04-06)

### Features

- update frourio@0.32.0 (https://github.com/frouriojs/create-frourio-app/pull/414)
- add eslint-disable comment for nuxt (https://github.com/frouriojs/create-frourio-app/pull/414)
...
- update frourio@0.30.2 (https://github.com/frouriojs/create-frourio-app/pull/398)

## [0.35.0](https://github.com/frouriojs/create-frourio-app/compare/v0.34.1...v0.35.0) (2022-11-23)

### Features

- update next@13.0.4 (https://github.com/frouriojs/create-frourio-app/commit/a2e38f1b718473cf915ad66841d72aa36114e9c3)
- change class-validator to zod (https://github.com/frouriojs/create-frourio-app/commit/f8799c0bb0f3d944c596974c18863a3d18064ad1)
- update typescript@4.9.3 and frourio@0.30.1 (https://github.com/frouriojs/create-frourio-app/commit/26f24164cd9b76d27d3d11e1ff56bcf52447e6c1)

## [0.34.1](https://github.com/frouriojs/create-frourio-app/compare/v0.34.0...v0.34.1) (2022-09-04)

### Bug Fixes

- fix: install typescript@4.7.4 (https://github.com/frouriojs/create-frourio-app/pull/391)

## [0.34.0](https://github.com/frouriojs/create-frourio-app/compare/v0.33.3...v0.34.0) (2022-09-04)

### Features

- feat: update deps and fix npm scripts (https://github.com/frouriojs/create-frourio-app/pull/388)

## [0.33.3](https://github.com/frouriojs/create-frourio-app/compare/v0.33.2...v0.33.3) (2022-07-27)

### Bug Fixes

- fix: avoid creating websocket connection in client (https://github.com/frouriojs/create-frourio-app/pull/382)

## [0.33.2](https://github.com/frouriojs/create-frourio-app/compare/v0.33.1...v0.33.2) (2022-07-27)

### Bug Fixes

- fix: add children type to React.FC (https://github.com/frouriojs/create-frourio-app/pull/381)

## [0.33.1](https://github.com/frouriojs/create-frourio-app/compare/v0.33.0...v0.33.1) (2022-07-27)

### Bug Fixes

- fix(template): minor fixes for package.json script (https://github.com/frouriojs/create-frourio-app/pull/367)

### Maintenance

- chore: use webpack for lib instead of tsc (https://github.com/frouriojs/create-frourio-app/pull/374)

## [0.33.0](https://github.com/frouriojs/create-frourio-app/compare/v0.32.6...v0.33.0) (2022-05-09)

### Features

- fastify-\*\*\*_ to @fastify/_\*\*\* (https://github.com/frouriojs/create-frourio-app/pull/363)

## [0.32.6](https://github.com/frouriojs/create-frourio-app/compare/v0.32.5...v0.32.6) (2022-04-11)

### Bug Fixes

- fix: pin react types versions (https://github.com/frouriojs/create-frourio-app/pull/353)
